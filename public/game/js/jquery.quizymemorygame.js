...
(function($) {
  ...
  var methods = {
      ...
      init : function(options) {
          ...
          // if it's the second click out of two (turning the second card)
            ...
            if(tClass == selItemClass){
              ...
              window.location.reload();
					...
					//onFinishCall({ clicks: numTotalClicks, time: numSeconds } );
        ...
        if(opts.gameSummary){
          ...
          $('#quizy-game-summary').append('<div id="gs-closebut" class="btn btn-success">'+
  ...
  ****************************************************************************/
  ...
  $.fn.quizyMemoryGame.defaults = {itemWidth: 156, itemHeight: 156, itemsMargin:10, colCount:4, animType:'scroll', animSpeed:250, openDelay:2500, flipAnim:'rl', resultIcons:true, gameSummary:true, randomised:true, textSummaryTitle:'RESUMEN JUEGO', replayButton:true, replayButtonText:'Reiniciar', closeButtonText:'Siguiente', textSummaryClicks:'clicks', textSummaryTime:'segundos', onFinishCall:''}
