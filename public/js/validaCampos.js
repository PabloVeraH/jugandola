...
/*
$('#textNombre, #textApellido').validCampoFranz(' abcdefghijklmnñopqrstuvwxyzáéiou');
$('#textCiudad').validCampoFranz('-+0123456789 abcdefghijklmnñopqrstuvwxyzáéiou');
$('#textTelefono').validCampoFranz('+0123456789');
*/
